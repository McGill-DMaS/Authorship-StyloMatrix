...
public class Estimator {
	...
	public Estimator(Iterable<Document> docs, int iterations, int dimension, Random rand) {
		trnModel = new Model(rand);
		trnModel.niters = iterations;
		trnModel.K = dimension;
		this.rand = rand;
		trnModel.initNewModelForEstimation(docs);
	}

	public Estimator(String modelPath, Random rand) {
		this.rand = rand;
		trnModel = new Model(rand);
		trnModel.initEstimatedModel(modelPath);
	}
